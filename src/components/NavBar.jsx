    ...
    >
      <div
        className={`${scroll
          ...
          } h-[60px] fixed w-full max-w-screen-2xl z-50 top-0 md:h-[70px] transition-all ease-linear `}
      >
        <div
          className={`flex items-center h-[60px] md:h-[70px] justify-between mx-auto max-w-[90%] md:max-w-[90%] lg:max-w-[85%]`}
        >
          <img
            id="logo"
            loading="lazy"
